...
export default function ResidentialDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  const project = residentialProjects.find((p) => p.id === id)
  if (!project) notFound()
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-12 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <p className="text-accent font-medium tracking-widest uppercase mb-3">Residential</p>
